...
/** Tracking data for ApiPlayground actions */
export interface ApiPlaygroundTrackingData {
  action: 'click';
...
export interface UapiUplaygroundProps {
  ...
  onTrack?: (data: ApiPlaygroundTrackingData) => void;
