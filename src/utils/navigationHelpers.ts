...
export const getActiveNavItem = (currentPath: string, items: NavigationItem[]): NavigationItem | null => {
...
export const createBreadcrumb = (
  ...
  pathSegments.forEach((segment, index) => {
    ...
    const label = customLabel && isLast ? customLabel : (labels[segment] || segment);
...
export const navigationUtils = {
   ...
   */
  isActivePath: (currentPath: string, targetPath: string, exact = true): boolean => {
    if (exact) {
