...
export const FeatureCard: React.FC<FeatureCardProps> = ({
  ...
  const getCardStyles = () => {
    ...
    const variantStyles = {
      default:
        'bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-lg hover:border-gray-300 dark:hover:border-gray-600',
      gradient:
        'bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg hover:shadow-lg hover:from-gray-50 hover:to-gray-100 dark:hover:from-gray-700 dark:hover:to-gray-800',
      outlined:
        'border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-gray-400 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-800/50',
    ...
    <div className={getCardStyles()}>
      ...
      {badge && (
        <div className='absolute top-4 right-4'>
          <span
            className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${getBadgeStyles(badge.color)}`}
          >
            {badge.label}
          </span>
        </div>
      ...
      <div className='space-y-3'>
        <h3
          className={`font-bold text-gray-900 dark:text-white ${titleSizes[size]}`}
        >
          {title}
        </h3>
