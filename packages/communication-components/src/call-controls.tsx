...
/** Tracking data for CallControls actions */
export interface CallControlsTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UcallUcontrolsProps {
  ...
  onTrack?: (data: CallControlsTrackingData) => void;
