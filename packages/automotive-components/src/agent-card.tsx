...
/** Tracking data for AgentCard actions */
export interface AgentCardTrackingData {
  action: 'click';
...
export interface UagentUcardProps {
  ...
  onTrack?: (data: AgentCardTrackingData) => void;
...
export const UagentUcard = ({
  ...
  return (
    <div
      ...
      onClick={handleClick}
      role='region'
      aria-label='UagentUcard'
    >
      {children || 'UagentUcard Component'}
    </div>
  );
};
