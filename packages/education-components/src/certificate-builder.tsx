...
/** Tracking data for CertificateBuilder actions */
export interface CertificateBuilderTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UcertificateUbuilderProps {
  ...
  onTrack?: (data: CertificateBuilderTrackingData) => void;
...
export const UcertificateUbuilder = ({
  ...
  onTrack,
  trackingLabel,
  componentName = 'UcertificateUbuilder',
