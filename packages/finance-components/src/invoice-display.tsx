...
/** Tracking data for InvoiceDisplay actions */
export interface InvoiceDisplayTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UinvoiceUdisplayProps {
  ...
  onTrack?: (data: InvoiceDisplayTrackingData) => void;
...
export const UinvoiceUdisplay = ({
  ...
  onTrack,
  trackingLabel,
  componentName = 'UinvoiceUdisplay',
