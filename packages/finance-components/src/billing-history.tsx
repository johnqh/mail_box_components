...
/** Tracking data for BillingHistory actions */
export interface BillingHistoryTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UbillingUhistoryProps {
  ...
  onTrack?: (data: BillingHistoryTrackingData) => void;
...
export const UbillingUhistory = ({
  ...
  onTrack,
  trackingLabel,
  componentName = 'UbillingUhistory',
