...
/** Tracking data for MessageInput actions */
export interface MessageInputTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UmessageUinputProps {
  ...
  onTrack?: (data: MessageInputTrackingData) => void;
