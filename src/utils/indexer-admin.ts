...
export class IndexerAdminHelper {
  ...
  async createCampaign(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/campaigns/create`, {
      method: 'POST',
      headers: {
  ...
  async deactivateCampaign(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/campaigns/${encodeURIComponent(campaignId)}/deactivate`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async awardPoints(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/points/award`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async flagUser(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/points/flag-user`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async getOverviewStats(adminSignature: string): Promise<AdminOverviewStats> {
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/stats/overview`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
  ...
  async getFlaggedUsers(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/users/flagged?${params}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'x-admin-signature': adminSignature,
  ...
  async generateBulkCodes(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/admin/campaigns/bulk-codes`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
