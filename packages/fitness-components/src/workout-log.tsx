...
/** Tracking data for WorkoutLog actions */
export interface WorkoutLogTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UworkoutUlogProps {
  ...
  onTrack?: (data: WorkoutLogTrackingData) => void;
