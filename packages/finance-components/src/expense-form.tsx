...
/** Tracking data for ExpenseForm actions */
export interface ExpenseFormTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UexpenseUformProps {
  ...
  onTrack?: (data: ExpenseFormTrackingData) => void;
