...
/** Tracking data for XmlParser actions */
export interface XmlParserTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UxmlUparserProps {
  ...
  onTrack?: (data: XmlParserTrackingData) => void;
