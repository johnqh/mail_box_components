...
describe('ConfirmationDialog Component', () => {
  ...
  describe('Icon Rendering', () => {
    it('renders appropriate icon for each variant', () => {
      const variants = ['default', 'warning', 'danger', 'success', 'info'] as const;
  ...
  describe('Edge Cases', () => {
    ...
    it('handles empty or long messages gracefully', () => {
      const longMessage = 'This is a very long message that explains in great detail what action the user is about to take and why they should be careful about proceeding with this action.';
    ...
    it('handles rapid open/close state changes', () => {
      ...
      rerender(<ConfirmationDialog {...defaultProps} isOpen={false} onClose={onClose} />);
      expect(screen.queryByText('Confirm Action')).not.toBeInTheDocument();
      
      rerender(<ConfirmationDialog {...defaultProps} isOpen={true} onClose={onClose} />);
      expect(screen.getByText('Confirm Action')).toBeInTheDocument();
    });
  });
});