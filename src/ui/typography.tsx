...
export const PageTitle: React.FC<PageTitleProps> = ({
  ...
  return (
    <Component className={cn(pageTitleVariants({ variant, responsive, align, color }), className)}>
      {children}
    </Component>
  );
};
...
export const SectionTitle: React.FC<SectionTitleProps> = ({
  ...
  return React.createElement(
    Component,
    { className: cn(sectionTitleVariants({ variant, spacing, align }), className) },
    children
  );
};
