...
type DynamicImport<T = ComponentType<Record<string, unknown>>> = () => Promise<{
  default: T;
}>;

// Loading fallback options
export type LoadingFallback =
  | 'default'
  | 'minimal'
  | 'skeleton'
...
export const createUIComponents = (
  importMap: Record<string, () => Promise<any>>
) => {
...
export const createLibraryImports = (
  libraries: Record<string, () => Promise<any>>
) => {
  return libraries;
};
