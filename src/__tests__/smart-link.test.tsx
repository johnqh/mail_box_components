...
describe('SmartLink Component', () => {
  ...
  describe('Variants and Styling', () => {
    ...
    it('applies custom variant', () => {
      render(
        <RouterWrapper>
          <SmartLink to="/test" variant="muted">Muted Link</SmartLink>
        </RouterWrapper>
      );
    ...
    it('applies size variants', () => {
      render(
        <RouterWrapper>
          <SmartLink to="/test" size="lg">Large Link</SmartLink>
        </RouterWrapper>
      );
    ...
    it('applies custom className', () => {
      render(
        <RouterWrapper>
          <SmartLink to="/test" className="custom-class">Custom Link</SmartLink>
        </RouterWrapper>
      );
  ...
  describe('Props and Behavior', () => {
    it('forwards ref correctly for internal links', () => {
      ...
      render(
        <RouterWrapper>
          <SmartLink ref={ref} to="/test">Ref Link</SmartLink>
        </RouterWrapper>
      );
    ...
    it('forwards ref correctly for external links', () => {
      const ref = React.createRef<HTMLAnchorElement>();
      render(<SmartLink ref={ref} external to="/test">External Ref</SmartLink>);
    ...
    it('forces external variant when external prop is true', () => {
      render(<SmartLink external to="/internal-looking" variant="subtle">Forced External</SmartLink>);
...
describe('SmartContent Component', () => {
  describe('Basic Text Processing', () => {
    ...
    it('handles multiple mappings in same text', () => {
      ...
      render(
        <RouterWrapper>
          <SmartContent mappings={mappings}>Check our about and contact pages</SmartContent>
        </RouterWrapper>
      );
    ...
    it('preserves word boundaries', () => {
      ...
      render(
        <RouterWrapper>
          <SmartContent mappings={mappings}>The cat and the catastrophe</SmartContent>
        </RouterWrapper>
      );
    ...
    it('handles case insensitive matching', () => {
      ...
      render(
        <RouterWrapper>
          <SmartContent mappings={mappings}>Learn more about our services</SmartContent>
        </RouterWrapper>
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('applies custom className', () => {
      render(<SmartContent className="custom-content">Test content</SmartContent>);
  ...
  describe('Advanced Text Processing', () => {
    it('handles overlapping mappings correctly', () => {
      ...
      render(
        <RouterWrapper>
          <SmartContent mappings={mappings}>Read our privacy policy</SmartContent>
        </RouterWrapper>
      );
