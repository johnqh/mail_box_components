...
export class IndexerWebhookHelper {
  ...
  async processEmailSent(emailData: WebhookEmailSent): Promise<WebhookResponse> {
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/webhook/email-sent`, {
      method: 'POST',
      headers: {
  ...
  async processRecipientLogin(loginData: WebhookRecipientLogin): Promise<WebhookResponse> {
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/webhook/recipient-login`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async registerReferral(referralData: WebhookReferralRegistration): Promise<WebhookResponse> {
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/points/register-referral`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async processRefereeLogin(
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/points/referee-login`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async processLogin(loginData: WebhookLoginEvent): Promise<WebhookLoginResult> {
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/webhook/login`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
  ...
  async processSolanaWebhook(transactions: unknown[]): Promise<{
    ...
    const response = await fetch(`${getIndexerBaseUrl(this.config)}/api/solana/webhook`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
