...
/** Tracking data for StockTicker actions */
export interface StockTickerTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UstockUtickerProps {
  ...
  onTrack?: (data: StockTickerTrackingData) => void;
