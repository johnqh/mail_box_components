...
/** Tracking data for SeatingChart actions */
export interface SeatingChartTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UseatingUchartProps {
  ...
  onTrack?: (data: SeatingChartTrackingData) => void;
