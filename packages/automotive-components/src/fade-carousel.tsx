...
/** Tracking data for FadeCarousel actions */
export interface FadeCarouselTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UfadeUcarouselProps {
  ...
  onTrack?: (data: FadeCarouselTrackingData) => void;
