...
**Package**: `@sudobility/retail-components`
**Version**: 1.1.6
**Type**: ES Module + UMD

Retail and point-of-sale UI components for React.

### Components
- `PosTerminal` - Point-of-sale terminal interface
- `SmsComposer` - SMS composer component
