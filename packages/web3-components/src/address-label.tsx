...
export const AddressLabel: React.FC<AddressLabelProps> = ({
  ...
  const tooltipContent = showTooltip && (
    <div
      className={`fixed z-[9999] px-3 py-2 bg-popover text-popover-foreground text-xs ${designTokens.radius.md} ${designTokens.shadow.lg} whitespace-nowrap pointer-events-none`}
      style={{
