...
/** Tracking data for FacetedSearch actions */
export interface FacetedSearchTrackingData {
  action: 'click';
...
export interface UfacetedUsearchProps {
  ...
  onTrack?: (data: FacetedSearchTrackingData) => void;
