...
describe('Environment Detection Utils', () => {
  ...
  describe('isWalletBrowser function', () => {
    ...
    it('should return true for MetaMask browser', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 MetaMask/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });

    it('should return true for Trust Wallet browser', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) TrustWallet/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });

    it('should return true for Coinbase Wallet browser', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) CoinbaseWallet/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });

    it('should return true for Rainbow Wallet browser', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) Rainbow/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });

    it('should return true for Phantom browser', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) Phantom/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });
    ...
    it('should be case-insensitive for wallet detection', () => {
      mockWindow.navigator.userAgent =
        'Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) METAMASK/Mobile';
      expect(isWalletBrowser()).toBe(true);
    });
  });
