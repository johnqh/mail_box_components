...
/** Tracking data for ApiReference actions */
export interface ApiReferenceTrackingData {
  action: 'click';
  trackingLabel?: string;
  componentName?: string;
}

export interface UapiUreferenceProps {
  ...
  onTrack?: (data: ApiReferenceTrackingData) => void;
