...
describe('Typography Components', () => {
  describe('PageTitle', () => {
    ...
    it('renders with different variants', () => {
      const { rerender } = render(
        <PageTitle variant='hero'>Hero Title</PageTitle>
      );
    ...
    it('renders with different alignments', () => {
      const { rerender } = render(
        <PageTitle align='center'>Centered</PageTitle>
      );
  ...
  describe('SectionTitle', () => {
    ...
    it('renders with different variants', () => {
      const { rerender } = render(
        <SectionTitle variant='h2'>H2 Section</SectionTitle>
      );
  ...
  describe('BodyText', () => {
    ...
    it('renders with different variants', () => {
      const { rerender } = render(
        <BodyText variant='lead'>Lead text</BodyText>
      );
    ...
    it('renders with different colors', () => {
      const { rerender } = render(
        <BodyText color='muted'>Muted text</BodyText>
      );
  ...
  describe('TextLink', () => {
    ...
    it('renders with different variants', () => {
      ...
      expect(
        screen.getByRole('link', { name: 'Subtle link' })
      ).toBeInTheDocument();

      rerender(
        <TextLink href='/test' variant='muted'>
          Muted link
        </TextLink>
      );
      expect(
        screen.getByRole('link', { name: 'Muted link' })
      ).toBeInTheDocument();
    });
  });
});
