...
const pageContainerVariants = cva(
  "min-h-screen flex flex-col",
  {
    variants: {
      background: {
        default: ui.background.subtle, // bg-gray-50 dark:bg-gray-900
        surface: ui.background.surface, // bg-white dark:bg-gray-800  
...
export const PageContainer: React.FC<PageContainerProps> = ({
  ...
  return (
    <div className={cn(pageContainerVariants({ background, overflow }), className)}>
      {children}
    </div>
  );
};
