    ...
    const optimizeLoading = () => {
      ...
      const optimizeWalletLoading = () => {
        ...
        if (!document.querySelector('script[data-wallet-detection]')) {
          ...
          script.innerHTML = '(function() { window.walletPreload = { hasMetaMask: typeof window.ethereum !== "undefined", hasPhantom: typeof window.solana !== "undefined", hasWalletConnect: true }; })();';
      ...
      const prioritizeCriticalResources = () => {
        ...
        document.querySelectorAll('img[data-priority="low"]').forEach((element) => {
          const img = element as HTMLImageElement;
          img.loading = 'lazy';
          if ('fetchPriority' in img) {
      ...
      if ('PerformanceObserver' in window) {
        ...
        const lcpObserver = new PerformanceObserver((list) => {
          ...
          if (lastEntry && lastEntry.startTime > 2500) {
            ...
            console.warn('Poor LCP detected, implementing aggressive optimizations');
